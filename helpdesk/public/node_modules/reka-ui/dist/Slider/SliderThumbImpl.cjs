...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const percent = vue.computed(() => value.value === undefined ? 0 : Slider_utils.convertValueToPercentage(value.value, rootContext.min.value ?? 0, rootContext.max.value ?? 100));
      ...
      return vue.openBlock(), vue.createBlock(vue.unref(CollectionItem), null, {
        default: vue.withCtx(() => [
          vue.createVNode(vue.unref(Primitive_Primitive.Primitive), vue.mergeProps(_ctx.$attrs, {
            ...
            role: "slider",
            tabindex: vue.unref(rootContext).disabled.value ? undefined : 0,
            ...
            style: {
               ...
               * slower connections.
               */
              display: !vue.unref(isMounted) && value.value === undefined ? "none" : undefined
            },
